        ...
        return tslib_1.__generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 8:
                    _d.sent();
                    return [3 /*break*/, 11];
                case 9: return [4 /*yield*/, getArbitrageResponse(tmeApi, message, "Chose option")];
                case 10:
                    _d.sent();
                    _d.label = 11;
...
function getArbitrageResponse(tmeApi, reqMessage, resMessage) {
    ...
    return tmeApi.sendMessage(reqMessage.chat.id, resMessage, {
        reply_markup: {
            keyboard: [
                [{ text: config_1.TELEGRAM.commands.DENIZ }],
                [{ text: config_1.TELEGRAM.commands.SWIFT }],
                [{ text: config_1.TELEGRAM.commands.KORONA }],
            ],
        },
    });
}
