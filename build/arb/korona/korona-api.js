...
function getRateKoronaPayFromRus(receivingCountryId, receivingCurrencyId, receivingAmountWN) {
    ...
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        var response, data, _a, receivingAmount, sendingAmount, exchangeRate;
        return tslib_1.__generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    response = _b.sent();
                    data = response.data;
                    _a = data[0], receivingAmount = _a.receivingAmount, sendingAmount = _a.sendingAmount, exchangeRate = _a.exchangeRate;
                    return [2 /*return*/, {
                            ...
                            exchangeRate: new bignumber_js_1.default(exchangeRate),
                        }];
            }
        });
    });
